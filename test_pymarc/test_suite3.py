...
class TestSuite3(unittest.TestCase):
    def test_field_creation_and_attributes(self):
        ...
        f245 = Field(
            ...
            subfields=[
                Subfield('a', 'The title :'),
                Subfield('b', 'the subtitle /'),
    ...
    def test_field_format_field(self):
        # Subject field (6xx)
        f650 = Field(tag='650', indicators=[' ', '0'], subfields=[
            Subfield('a', 'History'),
            Subfield('x', '20th century'),
            Subfield('v', 'Biography')
        ])
    ...
    def test_record_more_properties(self):
        ...
        # Publisher/Pubyear
        r.add_field(Field(tag='260', indicators=[' ', ' '], subfields=[
            Subfield('b', 'O\'Reilly'),
            Subfield('c', '2023')
        ]))
    ...
    def test_field_get_subfields(self):
        f = Field(tag='245', subfields=[
            Subfield('a', 'Main title'),
            Subfield('b', 'Subtitle'),
            Subfield('a', 'Extra title')
        ])
    ...
    def test_title_properties(self):
        r = Record()
        r.add_field(Field(tag='245', indicators=['1', '0'], subfields=[
            Subfield('a', 'Main Title :'),
            Subfield('b', 'Subtitle /'),
            Subfield('c', 'Author.')
        ]))
        ...
        r.add_field(Field(tag='222', indicators=[' ', '0'], subfields=[
            Subfield('a', 'Key Title :'),
            Subfield('b', 'Key Subtitle')
        ]))
